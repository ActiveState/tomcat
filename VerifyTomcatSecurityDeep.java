...
public class VerifyTomcatSecurityDeep {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("--- Starting Ultimate Tomcat Security & Integration Verification ---");

        // 1. Setup Embedded Tomcat
        Tomcat tomcat = new Tomcat();
        tomcat.setPort(8080);

        // ---> NEW: Enable HTTP/2 Engine to test our manual cherry-picks <---
        ...
        tomcat.start();
        System.out.println("Embedded Tomcat started on port 8080 with HTTP/2 enabled.");

        File workDir = new File(baseDir, "work/Tomcat/localhost/ROOT");
        if (!workDir.exists()) workDir.mkdirs();

        // =========================================================================
        // TEST 1: HTTP/2 Protocol Engine Verification (CVE-2025-31650 & CVE-2023-44487)
        // =========================================================================
